...
interface ProvidersWrapperInterface extends ethers.utils.Interface {
  functions: {
...
export class ProvidersWrapper extends BaseContract {
  ...
  interface: ProvidersWrapperInterface;
