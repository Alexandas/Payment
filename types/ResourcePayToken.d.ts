...
interface ResourcePayTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class ResourcePayToken extends BaseContract {
  ...
  interface: ResourcePayTokenInterface;
