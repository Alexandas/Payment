...
interface TimeLimitResourceInterface extends ethers.utils.Interface {
  functions: {
    "__Init_Resource(tuple[],address,uint8)": FunctionFragment;
    "addToken(address,uint256)": FunctionFragment;
    "balances(bytes32)": FunctionFragment;
    "buy(bytes32,address,uint256,uint256)": FunctionFragment;
    "getValueOf(address,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "__Init_Resource",
    values: [{ token: string; price: BigNumberish }[], string, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "Buy(address,bytes32,address,uint256,uint256,uint8)": EventFragment;
...
export class TimeLimitResource extends BaseContract {
  ...
  interface: TimeLimitResourceInterface;
  ...
  filters: {
    ...
    "Buy(address,bytes32,address,uint256,uint256,uint8)"(
      payer?: null,
      account?: null,
      token?: null,
      amount?: null,
