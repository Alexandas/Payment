...
interface IProvidersWrapperInterface extends ethers.utils.Interface {
  functions: {
...
export class IProvidersWrapper extends BaseContract {
  ...
  interface: IProvidersWrapperInterface;
