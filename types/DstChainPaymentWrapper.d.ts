...
interface DstChainPaymentWrapperInterface extends ethers.utils.Interface {
  functions: {
...
export class DstChainPaymentWrapper extends BaseContract {
  ...
  interface: DstChainPaymentWrapperInterface;
